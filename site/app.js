const translations = {
  en: {
    ...
    description: "The most complete Security Skill Store for security engineers, combining security skills from Codex, Claude Code, OpenClaw, and GitHub with CWE, OWASP, and business workflow classification.",
    navHome: "Home",
    navExplore: "Explore Skills",
    navTrending: "Trending Now",
    navRankings: "Rankings",
    starRepo: "Star repo",
    sideCardKicker: "Security Skill Store",
    sideCardTitle: "The skill store built for security engineers.",
    globalSearchPlaceholder: "Search security skills, CWE, OWASP, tools",
    eyebrow: "Security Skill Store",
    heroTitle: "The best Skill Store for security engineers.",
    heroText: "The most comprehensive security skill collection on the web. It brings together security skills from Codex, Claude Code, OpenClaw and GitHub, then classifies them precisely by CWE, OWASP and business category.",
    ...
    starBannerTitle: "Star the most complete open Security Skill Store.",
    starBannerText: "A GitHub star helps more security engineers discover this catalog, compare the corpus faster, and keep the collection growing.",
  ...
  zh: {
    title: "Sec Skills Store",
    description: "最适合安全工程师的 Skill Store，汇聚 Codex、Claude Code、OpenClaw 与 GitHub 中的安全技能，并按照 CWE、OWASP 和业务类别精准分类。",
    navHome: "首页",
    ...
    starRepo: "点亮 Star",
    sideCardKicker: "Security Skill Store",
    sideCardTitle: "最适合安全工程师的 SKILL STORE",
    globalSearchPlaceholder: "搜索安全技能、CWE、OWASP、工具",
    eyebrow: "Security Skill Store",
    heroTitle: "最适合安全工程师的 SKILL STORE",
    heroText: "全网最全面的 security skill 集合。把 Codex、Claude Code、OpenClaw 与 GitHub 中的安全技能合为一体，并按照CWE、OWASP和业务类别精准分类。",
    ...
    starBannerTitle: "点亮全网最全面的开源 Security Skill Store。",
    starBannerText: "GitHub Star 会让更多安全工程师发现这个目录，更快比较技能覆盖范围，也让这个安全技能集合持续增长。",
    marketSnapshot: "索引概览",
    loading: "加载中",
    liveIndex: "索引已加载",
    metricSkills: "技能",
