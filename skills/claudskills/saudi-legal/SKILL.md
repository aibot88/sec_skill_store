---
name: saudi-legal
description: "الخدمات القانونية السعودية — Saudi legal services via Najiz & Wathq APIs for courts, deeds, and power of attorney"
metadata: {"openclaw": {"emoji": "⚖️", "requires": {"env": ["WATHQ_API_KEY"], "bins": ["curl"]}}}
---
